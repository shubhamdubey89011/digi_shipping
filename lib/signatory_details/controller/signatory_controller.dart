...
class SignatoryController extends GetxController {
  ...
  Future<void> saveDetails() async {
    try {
      ...
      await _dbHelper.insertDatToSqLite2(
  ...
  Future<bool> hasDataInTable() async {
    final data =
        await _dbHelper.fetchAllPartyDetails2(tableName: DbHelperKeys.signatoryDetailsColumn);
  ...
  Future<void> deleteAllDetails() async {
    try {
      int rowsDeleted = await _dbHelper.deleteAllDataFromTable2(
          tableName: 'signatorydetails');
  ...
  Future<void> loadDetails() async {
    try {
      ...
      final data =
          await _dbHelper.fetchLastPartyDetail2(tableName: 'signatorydetails');
